...
sets = {
    "l":True, 
      "c":True, 
      "cm":"AUTO LIKE FOR : 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭",  
    "winvite": False,
    "wblacklist": False,
    "tagsticker": False,
    "Sticker": False,
...
tagadd = {
    ...
    "wctext": "หวัดดีๆๆๆๆ",
    "lv": "จะรีบไปใหน หว่า",
    "b": "บัญชีนี้ถูกป้องกันด้วย\n AUTO BLOCK 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭 \nระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
    "c":"AUTO LIKE FOR 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭",
    "m": "กูมุดมาล่ะไองามไส้",
}
apalo = {
    "winvite": False,
    "wblacklist": False,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭 ", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ubded88d0491b56e25a590ebebbfeadcb"}}
                    sendTemplate(to,data)
                                    ...
                                    "header": {
                                        ...
                                        #        "size": "md"
                                            ...
                                            },
                                            {
                                                 ...
                                                 "action":{
                                                     "type":"uri",
                                                     "label":"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭",
                                                     "uri":"line://nv/profilePopup/mid=ubded88d0491b56e25a590ebebbfeadcb"
                                                 },
                                            },
                                        ]
                                    },
...
{
"text": "  is bot line 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭",
"size": "xs",
"margin": "none",
"color": "#00F5FF",
"wrap": True,
...
"uri": "line://nv/profilePopup/mid=ubded88d0491b56e25a590ebebbfeadcb",
                ...
                if text.lower() == "เรา":
                    contact = maxgie.getContact(sender)
                    sendTemplate(to,{"type":"flex","altText": "🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭","contents":{"type":"bubble","footer":{"type":"box","layout":"horizontal","contents":[{"color":"#333333","size":"xs","wrap":True,"action":{"type":"uri","uri":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},"type":"text","text":"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭","align":"center","weight":"bold"},{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://nv/profilePopup/mid=ubded88d0491b56e25a590ebebbfeadcb"},"type":"text","text":"ผู้สร้าง","align":"center","weight":"bold"}]},"styles":{"footer":{"backgroundColor":"#000000"},"body":{"backgroundColor":"#CCFFFF"}},"body":{"type":"box","contents":[{"type":"box","contents":[{"type":"separator","color":"#FF3333"},{"aspectMode":"cover","gravity":"bottom","aspectRatio":"1:1","size":"sm","type":"image","url":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},{"type":"separator","color":"#FF3333"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},{"type":"separator","color":"#FF3333"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://img.live/images/2019/02/10/1549778907829.jpg"},{"type":"separator","color":"#FF3333"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},{"type":"separator","color":"#FF3333"}],"layout":"vertical","spacing":"none","flex":1},{"type":"separator","color":"#FF3333"},{"type":"box","contents":[{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"md","wrap":True,"type":"text","text":" 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭","weight":"bold"},{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"md","wrap":True,"type":"text","text":"{}".format(contact.displayName),"weight":"bold"},{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"xs","wrap":True,"type":"text","text":"Status Profile:","weight":"bold"},{"type":"text","text":"{}".format(contact.statusMessage),"size":"xxs","wrap":True,"color":"#FF3333"}],"layout":"vertical","flex":2}],"layout":"horizontal","spacing":"md"},"hero":{"aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","type":"image","url":"https://obs.line-scdn.net/{}".format(contact.pictureStatus)}}})            
                ...
                if text.lower() == "ออน" or text.lower() == "runtime":
                    ...
                    contact = maxgie.getContact(sender)
                    start = time.time()
                    maxgie.sendMessage(to, "กำลังทดสอบความเร็ว")
                    ...
                    try:
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(maxgie.getContact(maxgieMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                                 "linkUrl": "line://nv/profilePopup/mid=ubded88d0491b56e25a590ebebbfeadcb"
                            }
                        }
                        sendTemplate(to, data)
...
#=====================================================================                
                ...
                elif text.lower() == 'speed':start = time.time();maxgie.sendMessage("ubded88d0491b56e25a590ebebbfeadcb", "🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#==============================================================================#
                        ...
                        maxgie.datamention(to,'🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭',nama)
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                  ...
                  #  
                    maxgie.unsendMessage(msg_id)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    maxgie.sendMessage(to, maxgie.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+maxgie.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': '🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
                    ...
                    if "/ti/g/" in msg.text.lower():
                        if sets["autoJoinTicket"] == True:
                            ...
                            #        sendSticker(group.id, str(sver), str(spkg), str(sid))
                                maxgie.unsendMessage(msg_id)
                                duc1(to, "🌟มุดเข้ามาล่ะไอสัส 555🌟" % str(group.name))
...
"type": "text"
                                          ...
                                          sendTemplate(to, data)                        
        if op.type == 26:
            print ("[  SELF BOT 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭 ] ")
            msg = op.message
            text = str(msg.text)
            msg_id = msg.id
            receiver = msg.to
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if msg.text.lower() == "เชคapi":
                    ...
                    data = {"type": "text","text": "{}".format(lisk),"sentBy": {"label": "list API", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ubded88d0491b56e25a590ebebbfeadcb"}}
                    sendTemplate(to,data)
#==============================================================================#
#==============================================================================#
        if op.type == 25:
